<?php
 ...
 $reservacionMod = new ReservacionModelo();
            ...
            <div class="app" id="app">
                ...
                <article class="content responsive-tables-page">
                    <div class="title-block">
                        <h1 class="title"> Lista de reservaciones </h1>
                                        ...
                                        <section class="example">
                                            <div class="table-flip-scroll">
                                                <table id="tblProductos" class="table table-striped table-bordered table-hover flip-content">
                                                    ...
                                                    <tbody>
                                                    <?php foreach($reservacionMod->listar() as $r): ?>
                                                        <tr>
                                                           <td><?php echo $r->__GET('id_reservacion'); ?></td>
                                                           <td><?php echo $r->__GET('num_reserv'); ?></td>
                                                           <td><?php echo $r->__GET('fecha'); ?></td>
                                                           <td><?php echo $r->__GET('nombres'); ?></td>
                                                           <td><?php echo $r->__GET('apellidos'); ?></td>
                                                           <td><?php echo $r->__GET('cedula'); ?></td>
                                                           <td><?php echo $r->__GET('habitaciones'); ?></td>
                                                            <td>
                                                                <a title="Editar" href="editProducto.php?user=<?php echo $r->__GET('id_reservacion'); ?>">
                                                                    <i class="fa fa-pencil"></i>
                                                                </a>
                                                                &nbsp;&nbsp;
                                                                <a title="Eliminar" href="control/Producto.control.php?user=<?php echo $r->__GET('id_reservacion'); ?>">
